...
* **Relevant models from previous post:**
	...
	3. _Improved DCGANs_: another improvement over the previous DCGAN baseline. It allows generating higher-resolution images.
